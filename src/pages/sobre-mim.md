...
Sociólogo em formação e desenvolvedor web _hobbista_. Uma combinação pouco convencional.
...
No desenvolvimento meus interesses são dispersos, passando desde a _cultura maker_, automação, sistemas Linux, DevOps e desenvolvimento web. Defensor do Software Livre, tenho focado bastante em estudar JavaScript e ciência de dados com Python e R no tempo livre. Uma tentativa de unir meus dois mundos, aparentemente inconciliáveis.
